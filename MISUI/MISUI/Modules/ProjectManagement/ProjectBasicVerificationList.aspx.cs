...
{
    public partial class ProjectBasicVerificationList : Base
    {
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            {
                dtProjects = objService1.PopulatePBasicByUserId(Session["LanguageSetting"].ToString(),
                        Session["user_id"].ToInt32(), Session["fiscal_year_id"].ToInt32());
            }
            //for npc users and others; 
            else
            {
                dtProjects = objService1.PopulatePBasicByMinistryId(Session["LanguageSetting"].ToString(),
                        ddlMinistry.SelectedValue.ToInt32(), Session["fiscal_year_id"].ToInt32());
            }
