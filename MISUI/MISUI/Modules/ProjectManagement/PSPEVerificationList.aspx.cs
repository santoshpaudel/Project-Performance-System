...
{
    public partial class PSPEVerificationList : Base
    {
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            //for npc users and others; 
                ...
                dtProjects = objService1.PopulatePSPEByMinistryId(
        ...
        {
            Label lblProjectName = (Label)lvProject.FindControl("lblPriority");
            lblProjectName.Text = GetLabel("Priority");
