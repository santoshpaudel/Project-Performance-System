<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectProgressList.aspx.cs" Inherits="MISUI.Modules.ProjectManagement.ProjectProgressList" %>
                ...
                <asp:ListView ID="lvProject" runat="server" OnLayoutCreated="lvProject_LayoutCreated">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <div >
                                    <asp:LinkButton ID="btnAdd" Text="नतिजा सूचक" Class="green" runat="server" CommandName="natijaSuchak" CommandArgument='<%#Eval("PROJECT_ID") %>'
