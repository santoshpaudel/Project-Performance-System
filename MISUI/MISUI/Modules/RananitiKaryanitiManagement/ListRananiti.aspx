...
CodeBehind="ListRananiti.aspx.cs" Inherits="MISUI.Modules.RananitiKaryanitiManagement.ListRananiti" %>
...
<div class="col-sm-1">
    ...
    <div class="col-sm-1">
        <asp:DropDownList ID="ddlSector" runat="server" CssClass="chosen-select" AutoPostBack="True" OnSelectedIndexChanged="ddlSector_SelectedIndexChanged" >
        </asp:DropDownList>
    </div>
    <br />
    <br />
    ...
    <div class="col-sm-1">
        <asp:DropDownList runat="server" CssClass="chosen-select" ID="ddlSubSector" />
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div>
                <asp:Button class="btn btn-primary" runat="server" OnClick="btnAddEditRananiti_Click"
                    ID="btnAddEditRananiti" Text="Add Rananiti" />
                <asp:ListView ID="lvRananiti" runat="server" OnLayoutCreated="lvRananiti_LayoutCreated">
                    <LayoutTemplate>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <asp:Label runat="server" ID="lblRananitiName"></asp:Label>
                                    </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <asp:LinkButton ID="btnAdd" Class="green" runat="server" CommandName="edit" CommandArgument='<%#Eval("RANANITI_ID") %>'
                                        OnCommand="BtnEdit_Command" ToolTip='Edit this row'>
             
                                                             <i class="ace-icon fa  fa-pencil  bigger-130"></i>
             
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="BtnDelete" Class="red" runat="server" CommandName="delete" CommandArgument='<%#Eval("RANANITI_ID") %>'
