<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportVerificationList.aspx.cs" Inherits="MISUI.Modules.ProjectManagement.ReportVerificationList" %>
                    ...
                    <div class="row">
                        <table class="table table-bordered table-responsive table-striped table-condensed">
                            <thead>
                                <tr>
                                    <td>
                                        <label for="selMinistry" class="control-label">
                                            <%=GetLabel("MINISTRY")%>
                                        </label>
                                    </td>
                                   <%-- <td>
                                        <label for="ddlBudgetHead" class="control-label">
