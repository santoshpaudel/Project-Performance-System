<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProjectStatusProblemsEffortsViewer.aspx.cs" Inherits="MISUI.CrystalViewer.ProjectTrans.ProjectStatusProblemsEffortsViewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="margin-left:-45px; margin-top:-20px">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
							<li> <a href="#">आयोजनाको स्थिति, समस्या र समाधानार्थ भएका प्रयासहरु </a>
								</li>
						</ul><!-- /.breadcrumb -->
